...
class MeasurementOperatingFeature implements MeasurementOperating, Serializable {

    private final static MeasurementOperatingType TYPE = MeasurementOperatingType.CX_OPERATING_FEATURES
