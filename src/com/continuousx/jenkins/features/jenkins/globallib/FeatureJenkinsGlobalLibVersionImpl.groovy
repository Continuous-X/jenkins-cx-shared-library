...
class FeatureJenkinsGlobalLibVersionImpl extends AbstractFeature {
    ...
    void runFeatureImpl() {
        ...
        logger.logInfo "${JenkinsConfig.JENKINS_CONFIG_GLOBAL_LIBRARY_JENKINS_CX_SHARED_LIB}:  ${this.jenkinsContext.library.${JenkinsConfig.JENKINS_CONFIG_GLOBAL_LIBRARY_JENKINS_CX_SHARED_LIB}.version}"
    }
